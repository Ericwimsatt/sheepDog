...
function writeValidTask(overrides = '') {
    const yaml = `
name: test-task
phases:
  - description: "Phase 1"
...
function writeTaskWithRunAfter() {
    const yaml = `
name: test-task
phases:
  - description: "Phase 1"
...
function writeTaskWithRunBeforeAll() {
    const yaml = `
name: test-task
phases:
  - description: "Phase 1"
...
function writeTaskWithAfterAll() {
    const yaml = `
name: test-task
phases:
  - description: "Phase 1"
...
function writeTaskWithEverything() {
    const yaml = `
name: test-task
phases:
  - description: "Phase 1"
...
`;
        ...
        mockSpawn.mockImplementation(() => ({
            on: vi.fn((event, cb) => {
                if (event === 'error')
                    cb(Object.assign(new Error('test failed'), { code: 1 }));
                if (event === 'exit')
                    onExitCb = cb;
            }),
        }));
